...
<head>
	...
	td:nth-of-type(10):before { content: "Descripción"; }	
	}
	</style>
 ...
 <div class="navMenu">   
  ...
  <div class="collapse navbar-collapse" id="navbarResponsive">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        <a class="nav-link" href="https://github.com/opencitydata/sociedad-bienestar-equipamientos-municipales/blob/master/README.md" style="text-decoration: none;">README</a>
      </li>
      <li class="nav-item">
